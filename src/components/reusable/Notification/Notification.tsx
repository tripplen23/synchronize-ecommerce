...
const Notification = ({ message, onClose }: any) => {
  ...
  // Determine the notification class and icon based on message content
  ...
  return (
    <div
      className={`flex items-center justify-between w-96 px-4 py-3 mx-auto mt-4 rounded-md shadow-lg ${notificationClass}`}
    >
